	...
	public partial class AboutBox : Window
	{
		...
		public string Version
		{
			get
			{
				...
				result = CalculatePropertyValue<AssemblyFileVersionAttribute>("Version", "");
		...
		public string Description
		{
			get
			{
				return string.Format("{0}\n\n{1}",
				  CalculatePropertyValue<AssemblyDescriptionAttribute>(propertyNameDescription, xPathDescription),
				  CalculatePropertyValue<AssemblyTrademarkAttribute>(propertyNameTrademark, xPathTrademark));
			}
		}
